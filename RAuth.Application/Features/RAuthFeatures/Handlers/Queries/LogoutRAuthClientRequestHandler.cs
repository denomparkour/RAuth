...
{
    public class LogoutRAuthClientRequestHandler(IUnitOfWork unitOfWork) : IRequestHandler<LogoutRAuthClient, string>
    {
        private readonly IUnitOfWork _unitOfWork = unitOfWork;
        public async Task<string> Handle(LogoutRAuthClient request, CancellationToken cancellationToken)
        {
